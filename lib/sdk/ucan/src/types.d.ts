...
export declare type CodecCode = typeof RAW_CODE;
export declare type HashCode = typeof sha256.code;
export declare type StringOf<T> = Opaque<string, T>;
/**
 ...
 */
export declare type Facts = Record<string, unknown>;
/**
 ...
 */
export declare type JWT = `${string}.${string}.${string}`;
/**
 ...
 */
export declare type Caveat = Record<string, unknown>;
export declare type Caveats = Caveat[];
/**
 ...
 */
export declare type Ability = `${string}/${string}` | `ucan/*` | '*';
/**
 ...
 */
export declare type Resource = `${string}:${string}` | `ucan:${string}` | `ucan:*` | `ucan:./*` | `ucan://${string}/*` | `ucan://${string}/${string}`;
/**
 *
...
export declare type Capabilities = Record<Resource, Abilities>;
 ...
 */
export interface IUcan<C extends Capabilities = Capabilities> extends UCANProps<C>, UCANArtifacts {
 ...
 */
export declare type UCANHTTPHeaders = Jsonify<{
    authorization: `Bearer ${JWT}`;
    ucans?: string;
}>;
export declare type IUcanStore = Map<string, IUcan>;
...
export interface AgentCreateOptions {
    driver?: Driver;
    resolveSigner: (exported: string | CryptoKeyPair | undefined) => Promise<ISigner<string | CryptoKeyPair>>;
}
/**
 * Varsig types
 */
